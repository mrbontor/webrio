...
<head>
    ...
    <!-- Bootstrap Dropzone CSS -->
    <link href="<?php echo base_url() ?>assets/vendors/dropify/dist/css/dropify.min.css" rel="stylesheet" type="text/css"/>
    <!-- Toggles CSS -->
    ...
    <div class="hk-wrapper hk-alt-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar hk-navbar-alt">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapseAlt">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url() ?>">Dashboard</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url() ?>pages">Pages</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url() ?>gallery">Gallery</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url() ?>settings">Setting</a></li>
                </ul>
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <span><?php echo $username ?><i class="zmdi zmdi-chevron-down"></i></span>
                            </div>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                        ...
                        <a class="dropdown-item" href="<?php echo base_url() ?>settings"><i class="dropdown-icon zmdi zmdi-settings"></i><span>Settings</span></a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="<?php echo base_url() ?>beranda/logout"><i class="dropdown-icon zmdi zmdi-power"></i><span>Log out</span></a>
                    </div>
                </li>
            </ul>
        </nav>
