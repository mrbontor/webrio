            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="subtitle" class="form-control" placeholder="title">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group row">
...
<script type="text/javascript">
    ...
    function show_data()
    {
        $.ajax({
            type  : 'get',
            url  : "<?php echo site_url('pages/ajax_list')?>",
            async : false,
            dataType : 'json',
            success : function(data){
                ...
                for(i=0; i<data.length; i++){
                    ...
                    if (data[i].image !== null) {
                        ...
                        $('#photo-preview div').html('<img src="'+base_url+'upload/pages/'+data[i].image+'" class="img-responsive" width="150" height="150">'); // show photo
                        $('#photo-preview div').append('<input type="checkbox" name="remove_photo" value="'+data[i].image+'"/> Remove photo when saving'); // remove photo

                        photo = '<a href="'+ base_url+ 'upload/pages/'+ data[i].image+'" target="_blank"><img src="'+ base_url +'upload/pages/'+ data[i].image+'"  class="img-responsive" width="75" height="77"/></a>'
                    } else {
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('pages/ajax_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                if(data.image)
                {
                    ...
                    $('#photo-preview div').html('<img src="'+base_url+'upload/pages/'+data.image+'" class="img-responsive" width="250" height="250"> <br>');
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            ...
            url = "<?php echo site_url('pages/ajax_update')?>";
        }
    ...
    function delete_data(id)
    {
        ...
        {
            $.ajax({
                url : "<?php echo site_url('pages/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
